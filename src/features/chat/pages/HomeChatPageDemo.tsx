                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex flex-col max-w-[80%] min-w-[120px]">
                          <div
                            className={`p-4 rounded-2xl shadow-sm relative transition-all duration-200 hover:shadow-md ${
                              isUser
                          ...
                          >
                            ...
                            <div
                              className={`text-xs opacity-75 mt-3 flex items-center justify-between ${
